...
def PVTrainingFunction(parameterSet):
    ...
    print(layerSize)
    nnModel = MyNeuralNetwork(inputOutputSize = inputOutputSize, neuralNetworkTypeName = 'FFN', hiddenLayerSize = layerSize, hiddenLayerStructure = structure, computeDevice='cuda')
    nnModel = customNN.CustomNN(inputOutputSize=inputOutputSize,
...
if __name__ == '__main__':
    ...
    preProcessor.LoadTrainingAndTestsData('tntData/exp02-3D-0.05-12s-N03.npy')

    

    run = 'R1'
    outFileName = f'exp04-{run}'
